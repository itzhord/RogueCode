    ...
    <div className=" flex flex-row  justify-center w-100 h-[60vh] bg-blue-950">
      <div className="font-bold">
        <div className="mt-[5rem] ml-[7rem]">
          ...
          <Link to="/Dashboard" className="bg-transparent border border-gray-300 text-gray-300 hover:border-white  hover:text-black hover:bg-white py-1 px-5 rounded-2xl">Register Now</Link>
        </div>
      </div>
      <div>
        <img
